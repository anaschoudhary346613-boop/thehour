...
function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/41220000000?text=Hello%2C%20I%20am%20interested%20in%20The%20Hour%20collection."
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-2xl shadow-[#25D366]/30 animate-float hover:scale-110 transition-transform duration-300"
